...
CREATE TABLE public.lab_results (
  ...
  CONSTRAINT lab_results_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id)
);
...
CREATE TABLE public.medical_backgrounds (
  ...
  CONSTRAINT medical_backgrounds_patient_id_fkey FOREIGN KEY (patient_id) REFERENCES public.patients(id)
);

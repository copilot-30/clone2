...
<div class="min-h-screen flex items-center justify-center bg-gray-100 p-4">
    <div class="bg-white p-8 rounded-lg shadow-xl w-full max-w-5xl">
        <h2 class="text-3xl font-bold text-emerald-600 mb-8 text-center">Edit Clinic: {{ $clinic->name }}</h2>
        ...
        <form action="{{ route('doctor.clinics.update', $clinic->id) }}" method="POST" class="grid grid-cols-1 md:grid-cols-2 gap-8">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-6">
                ...
                <div class="mb-4">
                    ...
                    <div id="operating_hours_container" class="space-y-2">
                        @php
                            ...
                            if (empty($oldOperatingHours) && !empty($operatingHours)) {
                                $oldOperatingHours = $operatingHours;
                            }
                        @endphp
                ...
                <div class="mb-4">
                    ...
                    <div id="facilities_container" class="space-y-2">
                        @php
                            ...
                            if (empty($oldFacilities) && !empty($facilities)) {
                ...
                <div class="flex items-center mb-4">
                    <input
                        ...
                        {{ old('is_hospital', $clinic->is_hospital) ? 'checked' : '' }}
                    />

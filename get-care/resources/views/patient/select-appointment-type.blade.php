    ...
    <div class="bg-white rounded-lg shadow-md p-6">
        ...
        <form action="{{ route('patient.show-date-time-selection') }}" method="GET">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
             ...
             <div id="googleAuthSection" class="hidden mt-4 p-4 bg-blue-50 border border-blue-200 rounded-lg text-center">
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        typeCards.forEach(card => {
            card.addEventListener('click', function() {
                ...
                // Clear previous content in move-here div.
               // Clear previous content in move-here div.
               Array.from(moveHereDiv.children).forEach(child => child.remove());

               // Append selected choice display
               moveHereDiv.appendChild(selectedChoiceDisplay);
               ...
               if (selectedType === 'clinic') {
                   ...
                   if (googleAuthSection && !hasGoogleAccessToken) { // Only show if user doesn't have token
                       moveHereDiv.appendChild(googleAuthSection);

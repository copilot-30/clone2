...
class CreatePatientTestRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('patient_test_requests', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('patient_test_requests');
    }
}
